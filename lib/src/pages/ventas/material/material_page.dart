...
import 'package:maquinados_correa/src/pages/ventas/material/material_controller.dart';

class MaterialesPage extends StatelessWidget {

  MaterialesController con = Get.put(MaterialesController());
  ...
  Widget _textAdd(BuildContext context){
    return SafeArea(
        child: Container(
          ...
          child: Column (
            children: [
              Icon(Icons.person_add, size: 120),
              Text(
                'NUEVO CLIENTE',
                style: TextStyle(
                  fontWeight: FontWeight.bold,
