...
import 'package:maquinados_correa/src/pages/tym/newOperador/new_operador_controller.dart';

class OperadorPage extends StatelessWidget {

  OperadorPageController con = Get.put(OperadorPageController());
    ...
    return Container(
      ...
      child: TextField(
          ...
          decoration: InputDecoration(
            hintText: 'Nombre del operador', //texto fondo
  ...
  Widget _textAdd(BuildContext context){
    return SafeArea(
        child: Container(
          ...
          child: Column (
            children: [
              Icon(Icons.engineering_outlined, size: 120),
              Text(
                'NUEVO OPERADOR',
                style: TextStyle(
                  fontWeight: FontWeight.bold,
